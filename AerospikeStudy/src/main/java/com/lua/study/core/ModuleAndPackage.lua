...
Lua 的模块是由变量、函数等已知元素组成的 table，因此创建一个模块很简单，
...
require("com.lua.study.core.module.Module")
...
-- 别名变量 m
local m = require("com.lua.study.core.module.Module")
